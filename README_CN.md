...
> 最新项目架构图：[docs/project_architecture.html](docs/project_architecture.html)
...
- **项目架构 HTML**：[docs/project_architecture.html](docs/project_architecture.html) 展示数据、信号、融合选股、Agentic 复核、执行、风控、评估和运维的完整链路。

## 系统架构

完整的新设计请优先查看：[docs/project_architecture.html](docs/project_architecture.html)。
...
- [docs/project_architecture.html](docs/project_architecture.html) — 当前项目架构图和 Agentic/板块资金流新设计
